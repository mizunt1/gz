...
pgm = daft.PGM()
# x, y
pgm.add_node("z", r"z", 3-0.3, 3, aspect=1)
pgm.add_node("y", r"y", 3+0.3, 3, aspect=1, observed=True)
...
pgm.add_node("y2", r"y", 3+2.5+0.3, 3, aspect=1, observed=True)
pgm.add_edge("x2", "z2")
pgm.add_edge("y2", "z2")
...
pgm.render()
pgm.savefig("ssvae.pdf")
pgm.savefig("ssvae.png", dpi=150)
