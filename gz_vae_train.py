...
for epoch in range(args.num_epochs):
    ...
    if epoch % checkpoint_freq == 0:
        torch.save(ssvae.encoder_y.state_dict(), "checkpoints/" + args.checkpoint_dir + "/encoder_y.checkpoint")
        torch.save(ssvae.encoder_z.state_dict(), "checkpoints/" + args.checkpoint_dir + "/encoder_z.checkpoint")
        torch.save(ssvae.decoder.state_dict(),  "checkpoints/" + args.checkpoint_dir +  "/decoder.checkpoint")
