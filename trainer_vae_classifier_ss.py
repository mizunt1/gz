...
def train_ss_log_vae_classifier(dir_name, vae, vae_optim, vae_loss_fn, classifier, classifier_optim,
                             classifier_loss_fn, train_s_loader, train_us_loader,
                                test_loader, num_epochs, plot_img_freq=20, num_img_plt=9,
    ...
    for epoch in range(num_epochs):
        print("training")
        total_epoch_loss_vae, total_epoch_loss_classifier, total_epoch_acc, num_steps  = train_ss_vae_classifier(
            vae, vae_optim, vae_loss_fn, classifier,
            classifier_optim, classifier_loss_fn, train_s_loader, 
            train_us_loader, use_cuda=use_cuda)
...
train_ss_log_vae_classifier(args.dir_name, vae, vae_optim, Trace_ELBO().differentiable_loss,
                            ...
                            classifier_loss, train_s_loader, train_us_loader,
                            test_us_loader, args.num_epochs, use_cuda=use_cuda)
