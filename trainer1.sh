...
srun python trainer_vae.py\
    ...
    --dir_name encoder_decoder_increased_conv_in_layers\
    --arch encoder_decoder_larger_kern.py --lr 1.0e-3\
    --num_epochs 1400 --img_size 80 --crop_size 80 --z_size 100 --subset
